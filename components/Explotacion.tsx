...
//     const queryParams = `mac=${mac}&token=${token}&idioma=${idioma}&nave=${siteName}&idNave=${buildingPortalRef}&app=appmovilv3&type=nave`;
...
export default function WebViewExplotacion() {
    ...
    /* ---------- Obtener portalUrl (prod o dev) al montar -------- */
    useEffect(() => {
        (async () => {
    ...
    /* ------- Esperar a que baseUrl esté disponible -------- */
    if (!baseUrl) {
        return (
            <SafeAreaView style={styles.container}>
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <WebView
                ...
                /* … resto de props onError/onHttpError … */
                originWhitelist={["*"]}
                javaScriptEnabled
                domStorageEnabled
                startInLoadingState
